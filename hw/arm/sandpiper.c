/*
 * Sandpiper Zynq 7020 Board System emulation.
 *
 * Based on xilinx_zynq.c
 *
...
static void sandpiper_set_boot_mode(Object *obj, const char *str,
                                               Error **errp)
{
    SandpiperMachineState *m = SANDPIPER_MACHINE(obj);
    uint8_t mode = 0;
...
static void sandpiper_init(MachineState *machine)
{
    SandpiperMachineState *zynq_machine = SANDPIPER_MACHINE(machine);
...
static void sandpiper_machine_class_init(ObjectClass *oc, const void *data)
{
    ...
    ObjectProperty *prop;
    mc->desc = "Sandpiper Zynq 7020 Board";
    mc->init = sandpiper_init;
    mc->max_cpus = ZYNQ_MAX_CPUS;
    mc->ignore_memory_transaction_failures = true;
    mc->valid_cpu_types = valid_cpu_types;
    mc->default_ram_id = "zynq.ext_ram";
    prop = object_class_property_add_str(oc, "boot-mode", NULL,
                                         sandpiper_set_boot_mode);
...
static const TypeInfo sandpiper_machine_type = {
    .name = TYPE_SANDPIPER_MACHINE,
    .parent = TYPE_MACHINE,
    .class_init = sandpiper_machine_class_init,
    .instance_size = sizeof(SandpiperMachineState),
    .interfaces = arm_machine_interfaces,
};

static void sandpiper_machine_register_types(void)
{
    type_register_static(&sandpiper_machine_type);
}

type_init(sandpiper_machine_register_types)
